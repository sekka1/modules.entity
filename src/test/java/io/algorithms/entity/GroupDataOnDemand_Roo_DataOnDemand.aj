...
privileged aspect GroupDataOnDemand_Roo_DataOnDemand {
    ...
    public GroupEntity GroupDataOnDemand.getNewTransientGroup(int index) {
    ...
    public GroupEntity GroupDataOnDemand.getSpecificGroup(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public GroupEntity GroupDataOnDemand.getRandomGroup() {
        init();
    ...
    public boolean GroupDataOnDemand.modifyGroup(GroupEntity obj) {
        return false;
    }
    ...
    public void GroupDataOnDemand.init() {
        ...
        for (int i = 0; i < 10; i++) {
            GroupEntity obj = getNewTransientGroup(i);
            try {
                obj.persist();
