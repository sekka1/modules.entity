...
public interface DataStore {
     ...
     * @param inputStream
     */
    void putStream(String folder, String fileName, InputStream inputStream) throws IOException;
     ...
     * @return
     */
    InputStream getStream(String folder, String file) throws IOException;
